...
void SAssetEditorLeftArea::SelectDataPtr(UActionData* InAsset)
{
...
void SAssetEditorLeftArea::ReadDataAssetList()
{
	...
	EngineUtils::FindOrLoadAssetsByPath("/Game/08_Action", objects, EngineUtils::ATL_Regular);

	int32 index = 0;
	for (UObject* obj : objects)
	{
		UActionData* asset = Cast<UActionData>(obj);
